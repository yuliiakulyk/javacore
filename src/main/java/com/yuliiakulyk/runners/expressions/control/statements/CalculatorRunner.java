package com.yuliiakulyk.runners.expressions.control.statements;

import java.util.Scanner;

import com.yuliiakulyk.app.expressions.control.statements.Calculator;
import com.yuliiakulyk.runners.convertors.and.files.runners.EnumHometask;
